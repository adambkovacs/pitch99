    ...
    <div className="flex flex-col items-center justify-center px-8 max-w-5xl mx-auto text-center">
      <motion.div data-animate className="relative mb-4">
        ...
        <motion.div
          ...
          style={{ background: "radial-gradient(circle, rgba(167,139,250,0.15) 0%, rgba(249,115,22,0.08) 50%, transparent 70%)" }}
...
function SlideProblem() {
  const stats = [
    { icon: "⏱", value: "40+", unit: "hours", label: "spent building pitch decks", color: "from-red-500/20 to-transparent" },
    { icon: "🔄", value: "40", unit: "pitches", label: "needed to close a round", color: "from-amber-500/20 to-transparent" },
    { icon: "⏳", value: "2:24", unit: "min", label: "investors spend reviewing", color: "from-orange-500/20 to-transparent" },
    { icon: "📉", value: "97%", unit: "", label: "of pitches fail to get funded", color: "from-rose-500/20 to-transparent" },
  ];

  return (
    <div className="flex flex-col items-center justify-center px-8 max-w-5xl mx-auto">
      <div data-animate className="text-xs font-mono text-violet-400/80 uppercase tracking-[0.2em] mb-3">
        The Problem
      </div>
...
function SlideSolution() {
  const steps = [
    { num: "01", title: "Intake", desc: "GitHub, website, LinkedIn, uploads", gradient: "from-violet-500 to-purple-600" },
    { num: "02", title: "Research", desc: "Market, competitors, TAM/SAM", gradient: "from-purple-500 to-fuchsia-500" },
    { num: "03", title: "Generate", desc: "Slides, animations, talking points", gradient: "from-fuchsia-500 to-orange-400" },
    { num: "04", title: "Present", desc: "99 seconds. Q&A prep included.", gradient: "from-orange-400 to-amber-400" },
  ];
...
function SlideMarket() {
  const marketData = [
    { label: "Presentation SW (2025)", value: 8.2, color: "linear-gradient(90deg, #7c3aed, #a78bfa)" },
    { label: "AI Pres. Tools (2025)", value: 2.0, color: "linear-gradient(90deg, #a855f7, #c084fc)" },
    { label: "AI Pres. Tools (2033)", value: 10.0, color: "linear-gradient(90deg, #d946ef, #f0abfc)" },
    { label: "Presentation SW (2030)", value: 16.6, color: "linear-gradient(90deg, #f97316, #fdba74)" },
  ];
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center px-8 max-w-6xl mx-auto gap-12 lg:gap-16">
      <div className="flex-1 max-w-md">
        ...
        <p data-animate className="text-sm text-zinc-400 mb-8">
          presentation market by 2030, growing at <span className="text-violet-400 font-semibold">25% CAGR</span> for AI tools
        </p>
        ...
        <div data-animate className="space-y-3">
          {[
            ...
            <div key={item.text} className="flex items-start gap-3 text-sm">
              <span className="font-mono font-bold text-violet-400 min-w-[4rem] text-right">{item.num}</span>
    ...
    <div className="flex flex-col items-center justify-center px-8 max-w-4xl mx-auto text-center">
      <motion.div data-animate className="relative mb-6">
        ...
        <motion.div
          ...
          style={{ background: "radial-gradient(circle, rgba(167,139,250,0.12) 0%, rgba(249,115,22,0.06) 50%, transparent 70%)" }}
      ...
      <motion.div data-animate className="flex flex-col sm:flex-row gap-3 items-center mb-10">
        <a
          href="/intake"
          className="px-7 py-3.5 rounded-full bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold text-sm hover:from-violet-500 hover:to-purple-500 transition-all shadow-lg shadow-violet-500/20 hover:shadow-violet-500/30 hover:scale-[1.03] active:scale-[0.98]"
        >
          Create Your Pitch →
        </a>
        <a
          ...
          className="px-7 py-3.5 rounded-full border border-zinc-700/50 text-zinc-300 text-sm font-medium hover:border-violet-500/30 hover:text-zinc-100 transition-all"
        >
          View on GitHub
        </a>
      </motion.div>

      <div data-animate className="flex items-center gap-5 text-[10px] text-zinc-600 font-mono uppercase tracking-widest">
        <span>Next.js</span>
...
const slides: SlideData[] = [
  {
    id: 0,
    content: <SlideHook />,
    background: "radial-gradient(ellipse at 50% 20%, rgba(167,139,250,0.06) 0%, rgba(249,115,22,0.03) 40%, transparent 70%)",
  },
  {
    id: 1,
  ...
  },
  {
    ...
    background: "radial-gradient(ellipse at 70% 30%, rgba(167,139,250,0.05) 0%, rgba(217,70,239,0.03) 40%, transparent 70%)",
  },
  {
    id: 3,
    content: <SlideMarket />,
    background: "radial-gradient(ellipse at 40% 50%, rgba(167,139,250,0.05) 0%, rgba(249,115,22,0.03) 40%, transparent 70%)",
  },
  {
    id: 4,
    content: <SlideCTA />,
    background: "radial-gradient(ellipse at 50% 30%, rgba(167,139,250,0.08) 0%, rgba(249,115,22,0.03) 40%, transparent 70%)",
  },
];
